...
const Header = () => {
  ...
  return (
    <>
      {isSmallScreen ? (
        // Mobile Header
        <div className='flex justify-between items-center px-4 fixed top-0 w-full h-[60px] bg-gray-300 z-50 shadow-md'>
        ...
        // Desktop Header
        <div className='flex justify-between items-center px-8 fixed top-0 w-full h-[60px] bg-gray-400 z-50 shadow-md'>
